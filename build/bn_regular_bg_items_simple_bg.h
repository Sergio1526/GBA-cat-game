...
//
//	Time-stamp: 2024-08-14, 18:52:00
...
#define simple_bg_bn_gfxTilesLen 1280
extern const bn::tile simple_bg_bn_gfxTiles[40];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item simple_bg(
            regular_bg_tiles_item(span<const tile>(simple_bg_bn_gfxTiles, 40), bpp_mode::BPP_4, compression_type::NONE), 
