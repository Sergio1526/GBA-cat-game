...
#define cats_intro_hands_bn_gfxTilesLen 6144
extern const bn::tile cats_intro_hands_bn_gfxTiles[192];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item cats_intro_hands(
            regular_bg_tiles_item(span<const tile>(cats_intro_hands_bn_gfxTiles, 192), bpp_mode::BPP_8, compression_type::NONE), 
