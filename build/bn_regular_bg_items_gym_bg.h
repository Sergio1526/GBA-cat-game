...
#define gym_bg_bn_gfxTilesLen 6976
extern const bn::tile gym_bg_bn_gfxTiles[218];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item gym_bg(
            regular_bg_tiles_item(span<const tile>(gym_bg_bn_gfxTiles, 218), bpp_mode::BPP_4, compression_type::NONE), 
