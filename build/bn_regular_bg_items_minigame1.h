...
//	Total size: 128 + 23232 + 2048 = 25408
//
...
#define minigame1_bn_gfxTilesLen 23232
extern const bn::tile minigame1_bn_gfxTiles[726];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item minigame1(
            regular_bg_tiles_item(span<const tile>(minigame1_bn_gfxTiles, 726), bpp_mode::BPP_8, compression_type::NONE), 
