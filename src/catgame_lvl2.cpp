...
// Backgrounds
#include "bn_regular_bg_items_lvl2_bg.h"
...
{
    lvl2::lvl2() {}
    catgame::game_phases lvl2::execute(bn::sprite_text_generator &text_generator)
    {
        bn::backdrop::set_color(bn::color(0, 0, 0));
        bn::camera_ptr camera = bn::camera_ptr::create(0, 0);
        // Set current scene
        current_game_phase = catgame::game_phases::LVL2;
        ...
        // Backgrounds
        bn::regular_bg_ptr ground = bn::regular_bg_items::lvl2_bg.create_bg(256, 256); // Center
        // Generate map for collisions
        const bn::regular_bg_map_item &map_item = bn::regular_bg_items::lvl2_bg.map_item();
